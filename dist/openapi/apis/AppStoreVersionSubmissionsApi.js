...
exports.AppStoreVersionSubmissionsApi = void 0;
const runtime = __importStar(require("../runtime"));
const models_1 = require("../models");
/**
 *
 */
class AppStoreVersionSubmissionsApi extends runtime.BaseAPI {
    /**
     */
    appStoreVersionSubmissionsCreateInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.AppStoreVersionSubmissionCreateRequestToJSON)(requestParameters.appStoreVersionSubmissionCreateRequest)
            }, initOverrides);
    ...
    /**
     */
    appStoreVersionSubmissionsCreateInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.appStoreVersionSubmissionsCreateInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     */
    appStoreVersionSubmissionsDeleteInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    /**
     */
    appStoreVersionSubmissionsDeleteInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.appStoreVersionSubmissionsDeleteInstanceRaw(requestParameters, initOverrides);
        });
    }
}
exports.AppStoreVersionSubmissionsApi = AppStoreVersionSubmissionsApi;
