...
exports.TerritoryAvailabilitiesApi = void 0;
const runtime = __importStar(require("../runtime"));
const models_1 = require("../models");
/**
 *
 */
class TerritoryAvailabilitiesApi extends runtime.BaseAPI {
    /**
     */
    territoryAvailabilitiesUpdateInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.TerritoryAvailabilityUpdateRequestToJSON)(requestParameters.territoryAvailabilityUpdateRequest)
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.TerritoryAvailabilityResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    territoryAvailabilitiesUpdateInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.territoryAvailabilitiesUpdateInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
exports.TerritoryAvailabilitiesApi = TerritoryAvailabilitiesApi;
