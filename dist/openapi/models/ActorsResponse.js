...
exports.instanceOfActorsResponse = instanceOfActorsResponse;
exports.ActorsResponseFromJSON = ActorsResponseFromJSON;
exports.ActorsResponseFromJSONTyped = ActorsResponseFromJSONTyped;
exports.ActorsResponseToJSON = ActorsResponseToJSON;
 ...
 */
function instanceOfActorsResponse(value) {
    let isInstance = true;
    isInstance = isInstance && "data" in value;
    isInstance = isInstance && "links" in value;
    return isInstance;
}
function ActorsResponseFromJSON(json) {
    return ActorsResponseFromJSONTyped(json, false);
}
function ActorsResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json === undefined || json === null) {
        return json;
    }
    return {
        data: json["data"].map(Actor_1.ActorFromJSON),
...
function ActorsResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        data: value.data.map(Actor_1.ActorToJSON),
