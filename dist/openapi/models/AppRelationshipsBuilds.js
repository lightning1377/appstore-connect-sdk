...
exports.instanceOfAppRelationshipsBuilds = instanceOfAppRelationshipsBuilds;
exports.AppRelationshipsBuildsFromJSON = AppRelationshipsBuildsFromJSON;
exports.AppRelationshipsBuildsFromJSONTyped = AppRelationshipsBuildsFromJSONTyped;
exports.AppRelationshipsBuildsToJSON = AppRelationshipsBuildsToJSON;
 ...
 */
function instanceOfAppRelationshipsBuilds(value) {
    let isInstance = true;
    return isInstance;
}
function AppRelationshipsBuildsFromJSON(json) {
    return AppRelationshipsBuildsFromJSONTyped(json, false);
}
function AppRelationshipsBuildsFromJSONTyped(json, ignoreDiscriminator) {
...
function AppRelationshipsBuildsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
