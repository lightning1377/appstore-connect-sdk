...
exports.instanceOfGameCenterAchievementImageAttributes = instanceOfGameCenterAchievementImageAttributes;
exports.GameCenterAchievementImageAttributesFromJSON = GameCenterAchievementImageAttributesFromJSON;
exports.GameCenterAchievementImageAttributesFromJSONTyped = GameCenterAchievementImageAttributesFromJSONTyped;
exports.GameCenterAchievementImageAttributesToJSON = GameCenterAchievementImageAttributesToJSON;
 ...
 */
function instanceOfGameCenterAchievementImageAttributes(value) {
    let isInstance = true;
    return isInstance;
}
function GameCenterAchievementImageAttributesFromJSON(json) {
    return GameCenterAchievementImageAttributesFromJSONTyped(json, false);
}
function GameCenterAchievementImageAttributesFromJSONTyped(json, ignoreDiscriminator) {
...
function GameCenterAchievementImageAttributesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
