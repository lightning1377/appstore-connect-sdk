...
exports.instanceOfGameCenterDetailGameCenterAchievementsLinkagesResponse = instanceOfGameCenterDetailGameCenterAchievementsLinkagesResponse;
exports.GameCenterDetailGameCenterAchievementsLinkagesResponseFromJSON = GameCenterDetailGameCenterAchievementsLinkagesResponseFromJSON;
exports.GameCenterDetailGameCenterAchievementsLinkagesResponseFromJSONTyped = GameCenterDetailGameCenterAchievementsLinkagesResponseFromJSONTyped;
exports.GameCenterDetailGameCenterAchievementsLinkagesResponseToJSON = GameCenterDetailGameCenterAchievementsLinkagesResponseToJSON;
 ...
 */
function instanceOfGameCenterDetailGameCenterAchievementsLinkagesResponse(value) {
    let isInstance = true;
    isInstance = isInstance && "data" in value;
    isInstance = isInstance && "links" in value;
    return isInstance;
}
function GameCenterDetailGameCenterAchievementsLinkagesResponseFromJSON(json) {
    return GameCenterDetailGameCenterAchievementsLinkagesResponseFromJSONTyped(json, false);
}
function GameCenterDetailGameCenterAchievementsLinkagesResponseFromJSONTyped(json, ignoreDiscriminator) {
...
function GameCenterDetailGameCenterAchievementsLinkagesResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
