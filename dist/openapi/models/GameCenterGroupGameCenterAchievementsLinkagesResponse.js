...
exports.instanceOfGameCenterGroupGameCenterAchievementsLinkagesResponse = instanceOfGameCenterGroupGameCenterAchievementsLinkagesResponse;
exports.GameCenterGroupGameCenterAchievementsLinkagesResponseFromJSON = GameCenterGroupGameCenterAchievementsLinkagesResponseFromJSON;
exports.GameCenterGroupGameCenterAchievementsLinkagesResponseFromJSONTyped = GameCenterGroupGameCenterAchievementsLinkagesResponseFromJSONTyped;
exports.GameCenterGroupGameCenterAchievementsLinkagesResponseToJSON = GameCenterGroupGameCenterAchievementsLinkagesResponseToJSON;
 ...
 */
function instanceOfGameCenterGroupGameCenterAchievementsLinkagesResponse(value) {
    let isInstance = true;
    isInstance = isInstance && "data" in value;
    isInstance = isInstance && "links" in value;
    return isInstance;
}
function GameCenterGroupGameCenterAchievementsLinkagesResponseFromJSON(json) {
    return GameCenterGroupGameCenterAchievementsLinkagesResponseFromJSONTyped(json, false);
}
function GameCenterGroupGameCenterAchievementsLinkagesResponseFromJSONTyped(json, ignoreDiscriminator) {
...
function GameCenterGroupGameCenterAchievementsLinkagesResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
