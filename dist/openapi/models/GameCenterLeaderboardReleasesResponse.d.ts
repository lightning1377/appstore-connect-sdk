 ...
 */
export declare function instanceOfGameCenterLeaderboardReleasesResponse(value: object): boolean;
export declare function GameCenterLeaderboardReleasesResponseFromJSON(json: any): GameCenterLeaderboardReleasesResponse;
export declare function GameCenterLeaderboardReleasesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GameCenterLeaderboardReleasesResponse;
export declare function GameCenterLeaderboardReleasesResponseToJSON(value?: GameCenterLeaderboardReleasesResponse | null): any;
