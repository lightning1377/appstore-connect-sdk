...
import type { AlternativeDistributionDomainCreateRequest, AlternativeDistributionDomainResponse, AlternativeDistributionDomainsResponse, ErrorResponse } from "../models";
import { AlternativeDistributionDomainCreateRequestFromJSON, AlternativeDistributionDomainCreateRequestToJSON, AlternativeDistributionDomainResponseFromJSON, AlternativeDistributionDomainResponseToJSON, AlternativeDistributionDomainsResponseFromJSON, AlternativeDistributionDomainsResponseToJSON, ErrorResponseFromJSON, ErrorResponseToJSON } from "../models";
