...
import type { BuildBetaDetailResponse, BuildBetaDetailUpdateRequest, BuildBetaDetailsResponse, BuildWithoutIncludesResponse, ErrorResponse } from "../models";
import { BuildBetaDetailResponseFromJSON, BuildBetaDetailResponseToJSON, BuildBetaDetailUpdateRequestFromJSON, BuildBetaDetailUpdateRequestToJSON, BuildBetaDetailsResponseFromJSON, BuildBetaDetailsResponseToJSON, BuildWithoutIncludesResponseFromJSON, BuildWithoutIncludesResponseToJSON, ErrorResponseFromJSON, ErrorResponseToJSON } from "../models";
