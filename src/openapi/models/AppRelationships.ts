...
import { AppRelationshipsAppClipsFromJSON, AppRelationshipsAppClipsFromJSONTyped, AppRelationshipsAppClipsToJSON } from "./AppRelationshipsAppClips";
import type { AppRelationshipsAppCustomProductPages } from "./AppRelationshipsAppCustomProductPages";
import { AppRelationshipsAppCustomProductPagesFromJSON, AppRelationshipsAppCustomProductPagesFromJSONTyped, AppRelationshipsAppCustomProductPagesToJSON } from "./AppRelationshipsAppCustomProductPages";
import type { AppRelationshipsAppEncryptionDeclarations } from "./AppRelationshipsAppEncryptionDeclarations";
import { AppRelationshipsAppEncryptionDeclarationsFromJSON, AppRelationshipsAppEncryptionDeclarationsFromJSONTyped, AppRelationshipsAppEncryptionDeclarationsToJSON } from "./AppRelationshipsAppEncryptionDeclarations";
import type { AppRelationshipsAppEvents } from "./AppRelationshipsAppEvents";
import { AppRelationshipsAppEventsFromJSON, AppRelationshipsAppEventsFromJSONTyped, AppRelationshipsAppEventsToJSON } from "./AppRelationshipsAppEvents";
import type { AppRelationshipsAppInfos } from "./AppRelationshipsAppInfos";
import { AppRelationshipsAppInfosFromJSON, AppRelationshipsAppInfosFromJSONTyped, AppRelationshipsAppInfosToJSON } from "./AppRelationshipsAppInfos";
import type { AppRelationshipsBetaAppLocalizations } from "./AppRelationshipsBetaAppLocalizations";
import { AppRelationshipsBetaAppLocalizationsFromJSON, AppRelationshipsBetaAppLocalizationsFromJSONTyped, AppRelationshipsBetaAppLocalizationsToJSON } from "./AppRelationshipsBetaAppLocalizations";
import type { AppRelationshipsBetaAppReviewDetail } from "./AppRelationshipsBetaAppReviewDetail";
import { AppRelationshipsBetaAppReviewDetailFromJSON, AppRelationshipsBetaAppReviewDetailFromJSONTyped, AppRelationshipsBetaAppReviewDetailToJSON } from "./AppRelationshipsBetaAppReviewDetail";
import type { AppRelationshipsBetaGroups } from "./AppRelationshipsBetaGroups";
import { AppRelationshipsBetaGroupsFromJSON, AppRelationshipsBetaGroupsFromJSONTyped, AppRelationshipsBetaGroupsToJSON } from "./AppRelationshipsBetaGroups";
import type { AppRelationshipsBetaLicenseAgreement } from "./AppRelationshipsBetaLicenseAgreement";
import { AppRelationshipsBetaLicenseAgreementFromJSON, AppRelationshipsBetaLicenseAgreementFromJSONTyped, AppRelationshipsBetaLicenseAgreementToJSON } from "./AppRelationshipsBetaLicenseAgreement";
import type { AppRelationshipsBuilds } from "./AppRelationshipsBuilds";
import { AppRelationshipsBuildsFromJSON, AppRelationshipsBuildsFromJSONTyped, AppRelationshipsBuildsToJSON } from "./AppRelationshipsBuilds";
import type { AppRelationshipsCiProduct } from "./AppRelationshipsCiProduct";
import { AppRelationshipsCiProductFromJSON, AppRelationshipsCiProductFromJSONTyped, AppRelationshipsCiProductToJSON } from "./AppRelationshipsCiProduct";
import type { AppRelationshipsEndUserLicenseAgreement } from "./AppRelationshipsEndUserLicenseAgreement";
import { AppRelationshipsEndUserLicenseAgreementFromJSON, AppRelationshipsEndUserLicenseAgreementFromJSONTyped, AppRelationshipsEndUserLicenseAgreementToJSON } from "./AppRelationshipsEndUserLicenseAgreement";
...
import { AppRelationshipsGameCenterEnabledVersionsFromJSON, AppRelationshipsGameCenterEnabledVersionsFromJSONTyped, AppRelationshipsGameCenterEnabledVersionsToJSON } from "./AppRelationshipsGameCenterEnabledVersions";
import type { AppRelationshipsInAppPurchases } from "./AppRelationshipsInAppPurchases";
import { AppRelationshipsInAppPurchasesFromJSON, AppRelationshipsInAppPurchasesFromJSONTyped, AppRelationshipsInAppPurchasesToJSON } from "./AppRelationshipsInAppPurchases";
import type { AppRelationshipsInAppPurchasesV2 } from "./AppRelationshipsInAppPurchasesV2";
import { AppRelationshipsInAppPurchasesV2FromJSON, AppRelationshipsInAppPurchasesV2FromJSONTyped, AppRelationshipsInAppPurchasesV2ToJSON } from "./AppRelationshipsInAppPurchasesV2";
import type { AppRelationshipsPreOrder } from "./AppRelationshipsPreOrder";
import { AppRelationshipsPreOrderFromJSON, AppRelationshipsPreOrderFromJSONTyped, AppRelationshipsPreOrderToJSON } from "./AppRelationshipsPreOrder";
import type { AppRelationshipsPreReleaseVersions } from "./AppRelationshipsPreReleaseVersions";
import { AppRelationshipsPreReleaseVersionsFromJSON, AppRelationshipsPreReleaseVersionsFromJSONTyped, AppRelationshipsPreReleaseVersionsToJSON } from "./AppRelationshipsPreReleaseVersions";
import type { AppRelationshipsPromotedPurchases } from "./AppRelationshipsPromotedPurchases";
import { AppRelationshipsPromotedPurchasesFromJSON, AppRelationshipsPromotedPurchasesFromJSONTyped, AppRelationshipsPromotedPurchasesToJSON } from "./AppRelationshipsPromotedPurchases";
import type { AppRelationshipsReviewSubmissions } from "./AppRelationshipsReviewSubmissions";
import { AppRelationshipsReviewSubmissionsFromJSON, AppRelationshipsReviewSubmissionsFromJSONTyped, AppRelationshipsReviewSubmissionsToJSON } from "./AppRelationshipsReviewSubmissions";
import type { AppRelationshipsSubscriptionGracePeriod } from "./AppRelationshipsSubscriptionGracePeriod";
import { AppRelationshipsSubscriptionGracePeriodFromJSON, AppRelationshipsSubscriptionGracePeriodFromJSONTyped, AppRelationshipsSubscriptionGracePeriodToJSON } from "./AppRelationshipsSubscriptionGracePeriod";
import type { AppRelationshipsSubscriptionGroups } from "./AppRelationshipsSubscriptionGroups";
import { AppRelationshipsSubscriptionGroupsFromJSON, AppRelationshipsSubscriptionGroupsFromJSONTyped, AppRelationshipsSubscriptionGroupsToJSON } from "./AppRelationshipsSubscriptionGroups";
...
import { AppStoreVersionExperimentV2RelationshipsControlVersionsFromJSON, AppStoreVersionExperimentV2RelationshipsControlVersionsFromJSONTyped, AppStoreVersionExperimentV2RelationshipsControlVersionsToJSON } from "./AppStoreVersionExperimentV2RelationshipsControlVersions";
...
import { AppStoreVersionRelationshipsAppStoreVersionExperimentsFromJSON, AppStoreVersionRelationshipsAppStoreVersionExperimentsFromJSONTyped, AppStoreVersionRelationshipsAppStoreVersionExperimentsToJSON } from "./AppStoreVersionRelationshipsAppStoreVersionExperiments";
