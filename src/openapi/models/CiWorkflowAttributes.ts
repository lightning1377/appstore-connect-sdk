...
import { CiActionFromJSON, CiActionFromJSONTyped, CiActionToJSON } from "./CiAction";
import type { CiBranchStartCondition } from "./CiBranchStartCondition";
import { CiBranchStartConditionFromJSON, CiBranchStartConditionFromJSONTyped, CiBranchStartConditionToJSON } from "./CiBranchStartCondition";
import type { CiManualBranchStartCondition } from "./CiManualBranchStartCondition";
import { CiManualBranchStartConditionFromJSON, CiManualBranchStartConditionFromJSONTyped, CiManualBranchStartConditionToJSON } from "./CiManualBranchStartCondition";
import type { CiManualPullRequestStartCondition } from "./CiManualPullRequestStartCondition";
import { CiManualPullRequestStartConditionFromJSON, CiManualPullRequestStartConditionFromJSONTyped, CiManualPullRequestStartConditionToJSON } from "./CiManualPullRequestStartCondition";
import type { CiManualTagStartCondition } from "./CiManualTagStartCondition";
import { CiManualTagStartConditionFromJSON, CiManualTagStartConditionFromJSONTyped, CiManualTagStartConditionToJSON } from "./CiManualTagStartCondition";
import type { CiPullRequestStartCondition } from "./CiPullRequestStartCondition";
import { CiPullRequestStartConditionFromJSON, CiPullRequestStartConditionFromJSONTyped, CiPullRequestStartConditionToJSON } from "./CiPullRequestStartCondition";
import type { CiScheduledStartCondition } from "./CiScheduledStartCondition";
import { CiScheduledStartConditionFromJSON, CiScheduledStartConditionFromJSONTyped, CiScheduledStartConditionToJSON } from "./CiScheduledStartCondition";
import type { CiTagStartCondition } from "./CiTagStartCondition";
import { CiTagStartConditionFromJSON, CiTagStartConditionFromJSONTyped, CiTagStartConditionToJSON } from "./CiTagStartCondition";
