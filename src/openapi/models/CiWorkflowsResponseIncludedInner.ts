...
import { CiMacOsVersion, instanceOfCiMacOsVersion, CiMacOsVersionFromJSON, CiMacOsVersionFromJSONTyped, CiMacOsVersionToJSON } from "./CiMacOsVersion";
import { CiProduct, instanceOfCiProduct, CiProductFromJSON, CiProductFromJSONTyped, CiProductToJSON } from "./CiProduct";
import { CiXcodeVersion, instanceOfCiXcodeVersion, CiXcodeVersionFromJSON, CiXcodeVersionFromJSONTyped, CiXcodeVersionToJSON } from "./CiXcodeVersion";
import { ScmRepository, instanceOfScmRepository, ScmRepositoryFromJSON, ScmRepositoryFromJSONTyped, ScmRepositoryToJSON } from "./ScmRepository";
